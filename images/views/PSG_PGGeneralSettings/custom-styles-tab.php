...
if ($data instanceof stdClass) :
	...
	$defaultStylesheets = array(
		'style-light.css' => __('Light', 'portfolio-gallery'),
		'style-dark.css' => __('Dark', 'portfolio-gallery')
	);

	$stylesheetsFilePath = PSG_PGMain::getPluginPath() . DIRECTORY_SEPARATOR . 'style' . DIRECTORY_SEPARATOR . 'PG';
	...
	$customStyleKeys   = get_option(PSG_PGGeneralSettings::$customStyles, array());
	...
	<div class="custom-styles-tab feature-filter" style="float: left; display: none;">
		<div class="styles-list">
			...
			<p>
				<b><?php _e('Default stylesheets', 'portfolio-gallery'); ?></b>
			</p>
					...
					<li>
						<span class="style-title"><?php echo (isset($defaultStyleValues['name'])) ? htmlspecialchars($defaultStyleValues['name']) : __('Untitled'); ?></span>
							<span
								...
								title="<?php _e('Create a new custom style from this style', 'portfolio-gallery'); ?>"
								>
								<?php _e('Customize', 'portfolio-gallery'); ?> &raquo;
							</span>
			...
			<p>
				<b><?php _e('Custom stylesheets', 'portfolio-gallery'); ?></b>
			</p>
					...
					<li>
						<span class="style-title"><?php echo htmlspecialchars($customStyleKeyName); ?></span>
							...
							<span
								...
								title="<?php _e('Edit this style', 'portfolio-gallery'); ?>"
								>
								<?php _e('Edit', 'portfolio-gallery'); ?> &raquo;
							</span>
						...
						<span style="float: right;">&#124;</span>
							...
							<span
								...
								title="<?php _e('Delete this style', 'portfolio-gallery'); ?>"
								>
								<?php _e('Delete', 'portfolio-gallery'); ?>
							</span>
	...
	<div class="custom-styles-tab feature-filter" style="display: none;">
		<div class="style-editors">
			...
			<p>
				<b><?php _e('Custom style editor', 'portfolio-gallery'); ?></b>
			</p>

			<p class="style-editor">
				<?php _e('Select a stylesheet to start customizing it.', 'portfolio-gallery'); ?>
			</p>
			...
			<?php foreach($customStyleValues as $customStyleKey => $customStyleValue): ?>
				...
				<div class="style-editor <?php echo htmlspecialchars($customStyleKey); ?>" style="display: none;">
					...
					<p>
						<i><?php _e('Title', 'portfolio-gallery'); ?></i><br />
						<input
							type="text"
							name="<?php echo esc_html(PSG_PGGeneralSettings::$customStyles); ?>[<?php echo htmlspecialchars($customStyleKey); ?>][title]"
							value="<?php echo (isset($customStyleKeys[$customStyleKey]) && !empty($customStyleKeys[$customStyleKey])) ? $customStyleKeys[$customStyleKey] : __('Untitled', 'portfolio-gallery'); ?>"
						/>
					</p>

					<p>
						<i><?php _e('Style', 'portfolio-gallery'); ?></i><br />
						<textarea
							name="<?php echo PSG_PGGeneralSettings::$customStyles; ?>[<?php echo htmlspecialchars($customStyleKey); ?>][style]"
							rows="25"
							cols=""
