<?php
/**
 * Class PGSlideInserter
 *
 * @since 2.0.0
 * @author Stefan Boonstra
 */
class PSG_PGSlideInserter
{
	/**
	...
	static function localizeScript()
	{
		...
		wp_localize_script(
			...
			'portfolio_gallery_backend_script_editSlideshow',
			array(
				'data' => array(),
				'localization' => array(
					'confirm'       => __('Are you sure you want to delete?', 'portfolio-gallery'),
					'uploaderTitle' => __('Insert image', 'portfolio-gallery')
				)
			)
		);
	}
