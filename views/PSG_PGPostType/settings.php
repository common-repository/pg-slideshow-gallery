...
<nav class="nav-tab-wrapper">
      <a href="#pgs-slideshow"  id="pgntpgs-slideshow" class="nav-tab nav-tab-active active" onclick="ShowPGSubTab('pgs-slideshow');">As Slideshow</a>
 ...
 <a href="#pgs-theme"  id="pgntpgs-theme" class="nav-tab" onclick="ShowPGSubTab('pgs-theme');">Theme Options </a>
	...
	<div class="notice-success">
		<p><?php _e('To use this slideshow in your website, add these shortcodes to your posts or pages', 'portfolio-gallery'); ?>:</p>
	<p style="font-style: italic;">
	<?php echo esc_html($data->shortCode1); ?><br>
	<p><?php _e('Or insert Slideshow-Gallery block in the Gutenberg editor and select Slideshow type', 'portfolio-gallery'); ?>:</p>
</p>
</div>
	<table>
		<?php $groups = array(); ?>
		<?php if(count($data->settings) > 0): ?>
		<?php foreach($data->settings as $key => $value):  if(!isset($value['group']))continue; ?>
	...
	<div id="pgs-gallery" class="PGsubtab-content PGHiddenTab">
		<div class="notice-success">
		<p><?php _e('To use this as gallery in your website, add these shortcodes to your posts or pages', 'portfolio-gallery'); ?>:</p>
	<p style="font-style: italic;"><?php echo esc_html($data->shortCode2); ?>(Gallery with Lightbox)<br>
	</p>
	<p><?php _e('Or insert Slideshow-Gallery block in the Gutenberg editor and select type Gallery.', 'portfolio-gallery'); ?>:</p>
	</div>
	...
	<div id="pgs-skitter" class="PGsubtab-content PGHiddenTab">
		<div class="notice-success">	<p><?php _e('To use this slideshow in your website, add these shortcode to your posts or pages', 'portfolio-gallery'); ?>:</p>
