...
if(isset($attributes['selectedSlideshow'])) $sel=$attributes['selectedSlideshow'];
else
	return ob_get_clean();

if(isset($attributes['selectedType'])) $seltype=$attributes['selectedType'];

	PSG_PG::show($sel,$seltype);
